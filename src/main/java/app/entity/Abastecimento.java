...
public class Abastecimento implements Serializable {
    ...
    * @generated
    */
    @Column(name = "precolitro", nullable = true, unique = false, precision=8, scale=2, insertable=true, updatable=true)
    ...
    * @generated
    */
    @Column(name = "km", nullable = true, unique = false, scale=2, insertable=true, updatable=true)
