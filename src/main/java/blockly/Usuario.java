...
public static Var cadastrar(Var nome, Var email, Var senha, Var confirmasenha) throws Exception {
 return new Callable<Var>() {
   ...
   public Var call() throws Exception {
    ...
    System.out.println(
    Var.valueOf("Entrou no bloco ! ").getObjectAsString());

    System.out.println(senha.getObjectAsString());

    System.out.println(confirmasenha.getObjectAsString());

    if (
    Var.valueOf(senha.equals(confirmasenha)).getObjectAsBoolean()) {

        System.out.println(
        Var.valueOf("Entrou no IF ! ").getObjectAsString());
